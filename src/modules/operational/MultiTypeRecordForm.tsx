                        ...
                        if (ev) {
                            ...
                            if (matchingDetail) {
                                ...
                                if (recordType === 'metropolitano') {
                                    ...
                                    choferesCenas = String(sd.choferes?.cenas || '');
                                    choferesDesayunos = String(sd.choferes?.desayunos || '');
                                    pepsicoDesayunos = String(sd.pepsico?.desayunos || '');
                                    quintasCenas = String(sd.quintas?.cenas || '');
                                    quintasDesayunos = String(sd.quintas?.desayunos || '');
                                    pilotosAlmuerzos = String(sd.pilotos?.almuerzos || '');
                                }
                            }
                        }
                    }
